...
export const variants = [
  {
    ...
    description: "Vivir V1 Ochre review direction.",
    accent: "#C8802A",
  ...
  },
  {
    ...
    description: "Vivir V2 Sanctuary review direction.",
    accent: "#A8894F",
    palette: ["#0B0B0C", "#F4F1EA", "#A8894F", "#2F5D4A", "#8A857C", "#0C1F17"],
  },
  {
    slug: "v4-blue",
    version: "V4",
    ...
    description: "Vivir V4 Blue review direction.",
    accent: "#0096C7",
    palette: ["#0B0B0C", "#F4F1EA", "#0096C7", "#00B4D8", "#8A857C", "#0E1D23"],
  },
